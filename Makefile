...
SRC = ./sources/main.c \
	...
	./sources/utils/ft_utils5.c ./sources/exec/exec_utils.c ./sources/parsing/here_doc.c ./sources/parsing/utils_parsing.c ./sources/utils/ft_split.c ./sources/builtins/utils.c
